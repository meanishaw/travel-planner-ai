...
export const getPublicPlans = query({
  handler: async (ctx, args) => {
    ...
    //PROD
    const PUBLIC_PLAN_IDS = [
      "js7bpfm9r0hz2ejrtn8qqrx8rx84cndg",
      "js7awxm0faey253bntsyvm6rw984cv97",
      "js76rst9azmkzxvsvsjdederjh84afhm",
      "js7aj3z7pf1da42jjd7dzs7pyn84amx9",
      "js79ss425346tc2f98q7tjyqdn84bpsf",
      "js7b7d8xaa9hmcesjy99qhn02n84ahnc",
      "js78d2m79k06rhdqp9vsqbwh0584b29x",
      "js7amkh80bbr1wfdmth4195max84a1wn",
    ] as Id<"plan">[];
